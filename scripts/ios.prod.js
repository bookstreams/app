...
BPromise.all(buildPromises).then(function () {
	...
	sh.run("cordova create builds/ios it.manoxmano.disportinsport disportinsport");
	sh.run("cd builds/ios && cordova plugin add org.apache.cordova.file");
	sh.run("cd builds/ios && cordova plugin add org.apache.cordova.media");
	...
	sh.run("cd builds/ios && cordova -d plugin add ../../../phonegap-facebook-plugin/ --variable APP_ID=\"1547637065469542\" --variable APP_NAME=\"manoxmano\"");
